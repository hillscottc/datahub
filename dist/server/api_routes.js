...
var _plant = require('../database/models/plant');
...
router.get('/plants/', function (req, res) {
  ...
  _plant2.default.forge().query(function (qb) {
    //qb is knex query builder
    _plant2.default.setPlantsQuery(qb, { family: family, common: common, symbol: symbol, sci: sci });
